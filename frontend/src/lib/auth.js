...
class AuthService {
        ...
        try {
            ...
            if (auth) {
                ...
                try {
                    ...
                    console.warn("Firebase Google provider creation failed:", providerError);
                }
            }
            else {
                this.firebaseAvailable = false;
    ...
    async googleLogin() {
        ...
        try {
            ...
            if (error.code === "auth/popup-closed-by-user") {
                ...
                throw new Error("Firebase initialization error. Please refresh the page and try again.");
            }
    ...
    async changePassword(currentPassword, newPassword) {
        const response = await this.apiRequest(`${API_BASE_URL}/auth/change-password`, {
            method: "PATCH",
